...
public struct CloudSessionCompletion: Codable, Sendable { public let protocolVersion: Int; public let accessToken: String; public let expiresInSeconds: Int; public init(protocolVersion: Int, accessToken: String, expiresInSeconds: Int) { self.protocolVersion = protocolVersion; self.accessToken = accessToken; self.expiresInSeconds = expiresInSeconds } }
