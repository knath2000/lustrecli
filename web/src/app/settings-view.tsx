...
export function SettingsView({ connected, pollingInterval, jobsCount, destinationsCount, error, onPollingIntervalChange, onRefresh, onDisconnect }: Props) {
  ...
  return <div className="settings-page">
    ...
    <div className="settings-layout">
      <aside className="settings-index glass-panel" aria-label="Settings sections"><a href="#connection">Connection</a><a href="#refresh">Live refresh</a><a href="#capabilities">Capabilities</a><a href="#privacy">Privacy & security</a></aside>
