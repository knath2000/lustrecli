...
- Home's Active, Queued, Failed, and Completed modals provide search, destination filters, job selection, complete bounded worker logs, and state-valid transfer controls without a separate Downloads destination.
