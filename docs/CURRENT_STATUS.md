...
- Current accepted production artifacts are Vercel deployment `dpl_CNxCSPUybxzVHmTJQcuHkwTNawRC`, gateway version `06da3333-b17e-4d78-98a2-6cce2801c251` at `lustre-gateway.knath2000.workers.dev`, and asset Worker version `b9df82c1-f26c-42e2-841d-88229016ff19` at `lustre-feed-assets.knath2000.workers.dev`. Public Production has Feed acceptance, destinations, queueing, and media flags disabled; `/feed-acceptance` returns `404`.
