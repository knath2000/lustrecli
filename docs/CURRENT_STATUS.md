...
- Current production artifacts are Vercel deployment `dpl_14Hfc1R6jxpRkSSRszLYwK9qaKv9`, gateway version `7a405308-4aa3-4fb5-ae42-9b2d5e99f215` at `lustre-gateway.knath2000.workers.dev`, and asset Worker version `b9df82c1-f26c-42e2-841d-88229016ff19` at `lustre-feed-assets.knath2000.workers.dev`. Feed, destinations, queueing, media, and command wake are enabled in Production. Near-instant provider behavior remains a manual production acceptance checkpoint.
